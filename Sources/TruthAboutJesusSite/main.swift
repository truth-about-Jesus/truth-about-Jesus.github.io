...
struct TruthAboutJesusSite: Website {
    ...
    var description = "...things into which angels long to look. (1 Peter 1:12 ESV) -- in traditional Chinese and English. 天使也渴想能知道一點。 (1 Peter 1:12 Chinese NET (T)) -- 用繁體中文和英語。"
